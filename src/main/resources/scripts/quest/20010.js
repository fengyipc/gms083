...
function start(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            qm.sendNextPrev("如果你想正式成为骑士团的一部分，你必须先见见皇后。她在这个岛的中心，我和我的兄弟们想和你分享一些东西，这些东西在你走之前在冒险岛世界里被认为是#基本知识#K。这样可以吗？");
        } else if (status == 2) {
            qm.sendNextPrev("让我提醒你这是一次探索你可能已经注意到，在冒险岛世界的游戏NPC偶尔会向你寻求各种帮助。这样的帮助被称为#任务#K.当你完成任务时，你将会得到奖励，所以我强烈建议你努力完成枫树交给你的工作。");
        } else if (status == 3) {
