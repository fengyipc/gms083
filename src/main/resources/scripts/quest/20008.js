...
function start(mode, type, selection) {
    ...
    if (status == 0)
        ...
        if (selection == 0) {
            ...
            choice1 = selection;
            qm.sendSimple("我很高兴你没有逃跑，但是。。。你确定你想成为一名训练中的骑士吗？我要问的是，你是否愿意加入一个冒险骑士团，并因此被捆绑在皇后在任何时候？她可能是皇后，但她还是个孩子。你确定你能为她而战吗？我不会让内哈特知道的，所以告诉我你的真实感受。\如果皇后想要冒险岛世界的和平，那我就不管了. \r\n #L2#如果皇后想要冒险岛世界的和平，那我就不管了.#l \r\n #L3#只要我能成为一名骑士，我会忍受一切 #l");
            qm.forceStartQuest();
