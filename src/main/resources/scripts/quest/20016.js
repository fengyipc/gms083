...
function start(mode, type, selection) {
    ...
    if (status == 0) {
    	...
    	qm.sendNextPrev("这个岛叫做耶雷弗。多亏了皇后的魔法，这座岛通常像空中的小船一样漂浮在空中，在冒险岛世界周围巡逻。不过，现在我们停在这里是有原因的。");
    } else if (status == 3) {
    	qm.sendNextPrev("T这位年轻的女皇是枫之谷世界的统治者。什么？这是你听说过她的第一次？啊，是的。嗯，她是枫之谷世界的统治者，但她不喜欢来控制它。她从远处观看，以确保一切都很好。好吧，至少这是她一贯的作用。");
    } else if (status == 4) {
    	qm.sendNextPrev("但现在不是这样。我们已经在整个冒险岛世界找到了预示着黑法师复活的迹象。我们不能让黑法师回来恐吓冒险岛世界就像他过去一样！");
    } else if (status == 5) {
    	...
    	qm.sendNextPrev("我们必须变得更强这样我们就能击败黑法师如果他复活。我们的首要目标是防止他破坏冒险岛世界，而你将在其中扮演一个突出的角色。");
    } else if (status == 8) {
        ...
        qm.sendNext("我很高兴你清楚我们目前的状况但你知道在你目前的水平上你连面对Black Mage的手下都不够坚强更别说面对黑法师本人了事实上连他手下的手下都没有你将如何以你目前的水平保护冒险岛世界？");
    } else if (status == 10) {
