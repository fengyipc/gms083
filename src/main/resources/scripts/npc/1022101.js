            ...
            if (mode < 0)
                ...
                if (status == 0 && mode == 1) {
                                if(cm.getPlayer().getLevel() < 20) {
                                        cm.sendOk("你好，我是枫叶兑换商人!\r\n\r\n很抱歉，需要20级以上才能兑换。#k.");
                                        cm.dispose();
                                        return;
                                }
                                var outStr = "你好，我是枫叶兑换商人！\r\n";
                                outStr += "你现在有 #r#c" + itemToUse + "##k 片#t" + itemToUse + "#\r\n\r\n";
                                outStr += "#L1#用1片#t" + itemToUse + "#兑换"+ nxAmount + "点券#l\r\n";
                                outStr += "#L2#用1片#t" + itemToUse + "#兑换" + chairAmount + "把随机椅子" + (chairAmount > 1 ? "" : "") + "#l\r\n";
                                outStr += "#L3#用1片#t" + itemToUse + "#兑换" + weaponAmount + "件枫叶武器#l\r\n";
                                outStr += "#L4#用1片#t" + itemToUse + "#兑换" + buffAmount + "#t" + buff1ID + "#和" + buffAmount + "#t" + buff2ID + "##l\r\n";
                                outStr += "#L5#用1片#t" + itemToUse + "#兑换" + hiredMerchantLength + "个雇佣商人#l\r\n";
                                outStr += "#L5#我要去#m209000000##l\r\n";
                                ...
                                if(selection > 0) {
                                        if(!cm.haveItem(itemToUse) && vp == 0) {
                                                cm.sendOk("很抱歉,你没有#t" +itemToUse + "邀请点.");
                                                cm.dispose();
                                                return;
                                        }
                                }
